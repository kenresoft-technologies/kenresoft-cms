              ...
              <TabsContent value="edit" className="flex flex-col gap-4">
                <div className="flex flex-col gap-2">
                  <div className="flex items-center justify-between">
                    ...
                    {isNew && titleField && !slugAutoGenerated ? (
                      <button
                        type="button"
                        className="text-xs text-primary hover:underline"
                        onClick={() => {
                      ...
                      >
                        Resume auto-generating from {titleField.label}
                      </button>
                    ) : null}
                  </div>
                  <Input
                  ...
                  {slugAutoGenerated && titleField ? (
                    <p className="text-muted-foreground text-xs">
                      Auto-generated from {titleField.label}. Edit directly to override.
                    </p>
                  ) : isNew && titleField ? (
                    <p className="text-muted-foreground text-xs">
                      Auto-generation stopped once you edited this directly — use the link above to resume it.
                    </p>
                  ) : !isNew ? (
                    <p className="text-muted-foreground text-xs">
