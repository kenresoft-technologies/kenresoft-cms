...
import { uiContentRoute } from './routes/admin/ui-content';
...
import { publicUiContentRoute } from './routes/public/ui-content';
...
app.route('/api/v1/public/ui-content', publicUiContentRoute);
...
app.route('/api/v1/admin/ui-content', uiContentRoute);
